...
<head>
  ...
  <title> ATTACHOPAP! | Opportunities </title>
...
<body onload="logoBeat()" style="font-family: 'Sora', sans-serif;">
  ...
  <!-- Main Container -->
  <div class="container-fluid" style=" background-color: #18303B; background-position: center; background-size: 100%; background-repeat: no-repeat; background-attachment: fixed;">
      ...
      <div style="width: 100%" class="row">
        <div class="col-md-12">
          <div style=" margin-top: 30px; padding-left: 200px;">
            <h1 id="jbs">Find Opportunities</h1>
            <form class="example" action="jobs.php">
              <input style="color:#000; height:45px; width:500px; border-radius:30px 0px 0px 30px;" type="text" placeholder="Search For Jobs.." name="q">
              <button type="submit" style="height:45px; width:40px; border-radius:0px 30px 30px 0px; background-color: #257059; "><i class="fa fa-search bb"></i></button>
            </form>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <?php if (isset($_GET['msg'])) {
            $msg = $_GET['msg'];
            if ($msg == 'success') {
              echo  "<h4 class='modal-title' style='color: black;'>Job Applied Successfully!</h4>";
            } else if ($msg == 'error') {
              echo  "<h4 class='modal-title'>Some Error occured Please try again later!</h4>";
            } else if ($msg == 'dup') {
              echo "<h4 class='modal-title' style='color: black;'>You have already applied for this job.\n "
